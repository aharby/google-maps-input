...
class $aae6ff17d8424da8$var$GeopointInput extends (0, $7XdDa$react).PureComponent {
    ...
    handleChange = (latLng, formatted_address, address_components)=>{
        ...
        onChange([
            ...
            (0, $7XdDa$set)(formatted_address, [
                "formatted_address"
            ]),
            (0, $7XdDa$set)(address_components, [
                "address_components"
            ])
        ]);
    };
    ...
    render() {
        ...
        return /*#__PURE__*/ (0, $7XdDa$jsxs)((0, $7XdDa$Fragment), {
            children: [
                value && /*#__PURE__*/ (0, $7XdDa$jsxs)((0, $7XdDa$ChangeIndicator), {
                    path: path,
                    isChanged: changed,
                    hasFocus: !!focused,
                    children: [
                        /*#__PURE__*/ (0, $7XdDa$jsx)("p", {
                            children: /*#__PURE__*/ (0, $7XdDa$jsx)("strong", {
                                children: value.formatted_address
                            })
                        }),
                        /*#__PURE__*/ (0, $7XdDa$jsx)((0, $8e8668abdcaeab13$export$1c4ad7c095d42d37), {
