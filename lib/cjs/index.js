...
class $a24f16af03c18a4b$export$9a2476e65b6b92a7 extends (0, ($parcel$interopDefault($dyHF6$react))).PureComponent {
    ...
    handlePlaceChanged = (place)=>{
        if (!place.geometry?.location || !place.formatted_address || !place.address_components) return;
        this.setValue(place.geometry.location, place.formatted_address, place.address_components);
    };
    setValue(geoPoint, formatted_address, address_components) {
        if (this.props.onChange) this.props.onChange(geoPoint, formatted_address, address_components);
    }
    render() {
        const { api: api , defaultZoom: defaultZoom , value: value  } = this.props;
...
class $6c4d418093d85b71$var$GeopointInput extends (0, ($parcel$interopDefault($dyHF6$react))).PureComponent {
    ...
    handleChange = (latLng, formatted_address, address_components)=>{
        ...
        onChange([
            ...
            (0, $dyHF6$sanity.set)(formatted_address, [
                "formatted_address"
            ]),
            (0, $dyHF6$sanity.set)(address_components, [
                "address_components"
            ])
        ]);
    };
    ...
    render() {
        ...
        return /*#__PURE__*/ (0, $dyHF6$reactjsxruntime.jsxs)((0, $dyHF6$reactjsxruntime.Fragment), {
            children: [
                value && /*#__PURE__*/ (0, $dyHF6$reactjsxruntime.jsxs)((0, $dyHF6$sanity.ChangeIndicator), {
                    path: path,
                    isChanged: changed,
                    hasFocus: !!focused,
                    children: [
                        /*#__PURE__*/ (0, $dyHF6$reactjsxruntime.jsx)("p", {
                            children: /*#__PURE__*/ (0, $dyHF6$reactjsxruntime.jsx)("strong", {
                                children: value.formatted_address
                            })
                        }),
                        /*#__PURE__*/ (0, $dyHF6$reactjsxruntime.jsx)((0, $116268a9005e03a0$export$1c4ad7c095d42d37), {
